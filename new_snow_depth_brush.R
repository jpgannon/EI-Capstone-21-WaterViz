                ...
                tabsetPanel(
                  ...
                  tabPanel("Snow Temperature Heat Map", 
                           sidebarLayout(
                             sidebarPanel(
                               dateInput("startdate", label = "Start Date", val= "2020-12-14"), 
                               dateInput("enddate", label= "End Date", val = "2021-04-15"),
                             ...
                             mainPanel(plotOutput("var4", width = "100%", height = "215px",
                                       ...
                                       plotOutput("line_snow", width = "100%", height = "215px",
...
server <- function(input, output, sessions) {
  ...
  output$line_snow <- renderPlot({
    well9_15_RTD%>% filter(TIMESTAMP > filterdate$x[1] & TIMESTAMP < filterdate$x[2]) %>% 
